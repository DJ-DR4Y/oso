...
const starTexture = new THREE.TextureLoader().load('./images/spikey.png')
...
textureLoader.load('./images/earth-1/earth_atmos_4096.jpg', function (tex) {
...
textureLoader.load('./images/earth-1/earth_specular_2048.jpg', function (tex) {
...
const earthLights = textureLoader.load('./images/earth-1/earth_lights_2048.png');
...
const clouds = textureLoader.load('./images/earth-1/earth_clouds_2048.png');
...
// const meteorTexture = new THREE.TextureLoader().load('./moon-v2.jpg')
// const normalTexture = new THREE.TextureLoader().load('./images/moon-normal_v2.jpg')
